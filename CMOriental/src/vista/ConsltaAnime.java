...
public class ConsltaAnime extends JDialog implements ActionListener {
	...
	private void cargarComboAnime() {
		...
		ArrayList<ContenidoMultimedia> man = dao.getCM(false);
	...
	Anime ani = dao.consultaAnime(Integer.parseInt(cod.substring(0,donde)));
	Autor aut = dao.consultaAutor(com.getAutor());
